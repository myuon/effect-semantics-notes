...
| 4 | recursion-free normalization and reducibility | `C1-CERT.3.1`, `C1-PROOF.4.1`, `C1-PROOF.4.2` | **Precisely scoped; fragment checked** | `LanguageVal.NoFix`, `LanguageComp.NoFix`, substitution and `LanguageStep.preserve_noFix` checked; logical reducibility plus a well-founded response kernel remain |
