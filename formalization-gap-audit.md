...
| 4 | recursion-free normalization and reducibility | `C1-CERT.3.1`, `C1-PROOF.4.1`, `C1-PROOF.4.2` | **Repaired boundary** | relabelled conjecture: current grammar contains `fixLam`; exact future target requires `NoFix` plus a well-founded response kernel |
