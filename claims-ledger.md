...
| C-263 | Derived on paper | Runtime traces of a typed base computation belong to the concretization of its ordered trace-language effect | primitive trace soundness; concatenation and union laws | formalize residual-trace invariant |
| C-264 | Derived for three instances | Exact Writer, state-and-trace and exception-and-trace models validate the Chapter-I operational observations and ground adequacy schemas | concrete machine calculations; one-step invariant | audit State trace-language closure |
| C-265 | Chapter-I theorem on paper | Writer, State and Exception instantiate `BaseCert`, exporting dynamics, trace soundness, graded semantics and declared adequacy to the free-operation extension | C-262--C-264 | use as sole Chapter-II input |
| C-266 | Adopted v5 correction | Base static effects denote completion-sensitive behavior languages; sequential product appends the tail only after normal return and absorbs it after a classified abort | Exception short-circuit counterexample | propagate the exit structure through Chapter-II free traces |
