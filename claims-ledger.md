...
| C-262 | Derived on paper | The recursion-free base calculus has unique return/redex/request decomposition, internal preservation and normalization under terminating deterministic base responses | Chapter I operational semantics; reducibility | independent proof audit |
...
| C-264 | Revised for three instances | Writer, State and Exception validate their ordinary machine observations and ground adequacy schemas without a common trace model | concrete machine calculations; one-step semantic invariant | audit phantom grading coherence |
| C-265 | Chapter-I theorem revised | Writer, State and Exception instantiate `BaseCert`, exporting dynamics, upper-bound effect safety, graded semantics and declared adequacy | C-262; C-264; C-267--C-269 | use as sole Chapter-II input |
...
| C-272 | Derived conditional | If the polynomial initial algebras exist, $\mathsf F_\Sigma(T)\cong T(A+\Sigma\mathsf F_\Sigma(T)A)$ yields a strong graded free extension with canonical base embedding | strong graded $T$; coherent weakening; initiality | make grade-refined carrier construction fully explicit |
| C-273 | Derived conditional | Base morphisms and bind-compatible logical relations lift through the finite free extension | C-272; generator compatibility | expand relation bind proof |
| C-274 | Derived conditional | Chapter-I ground adequacy lifts to finite returns, base outcomes and exposed free requests when the observation separates their constructors | `BaseCert`; normalization; constructor separation | formalize extensional continuation observation |
...
| C-285 | Chapter-IV theorem conditional on paper | `RecBaseCert` plus handler and effect-closure certificates yields `DeepCert` with recursive safety, definability, elimination and level-indexed adequacy | C-281--C-284 | independent proof audit |
| C-286 | Detailed paper derivation | Chapter-I substitution, preservation, decomposition and normalization follow from simultaneous typing induction, unique CBV contexts and reducibility | terminating typed base boundaries | mechanize syntax metatheory |
...
| C-289 | Detailed conditional derivation | Chapter-IV coincidence, elimination and adequacy follow by finite approximants, finite-prefix invariance and admissible fixed-point induction | `RecBaseCert`; continuity; closure-compatible effects | domain-theoretic formalization |
