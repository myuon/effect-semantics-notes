...
arbitrary grades; its action is derived from the FreeT structure. The
...
2. $\operatorname{FreeT}_\Delta(T)$ exists as a strong graded monad with its
   universal base embedding and free generators;
...
unique fold generated by $q$ on returns, old layers and new generators. Its
compatibility with the canonical actions follows from preservation of
base multiplication.
